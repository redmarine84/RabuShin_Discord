-- ============================================================
-- Migration 61 emergency rollback
--
-- Restores the previous discord_get_character return signature without
-- gender. Saved gender values remain in discord_characters and are not
-- deleted, but the old client loop will return if Build 6.23.1 is active.
-- Use only for emergency database rollback.
-- ============================================================
